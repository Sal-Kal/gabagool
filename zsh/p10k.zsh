# Generated by Powerlevel10k configuration wizard on 2023-11-12 at 10:14 IST.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=195
  # Custom icon.
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%51F'   # green foreground
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_FOREGROUND=51
